    ...
    <div class="homeWap">
      <div class="footer-section clearfix">
        ...
        <div class="footer-contactus">
          ...
          <p>客服邮箱：<a style="cursor:pointer;" onclick="location.href=''">xxxx@xx.com</a></p>
        </div>
        <div class="footer-ewm">
          <img src="${pageContext.request.contextPath}/images/" alt="订阅号" />
          <p>订阅号</p>
        </div>
        <div class="footer-ewm">
          <img src="${pageContext.request.contextPath}/images/" alt="服务号" />
          <p>服务号</p>
        </div>
      </div>
      <div class="copyright">版权所有 ©2020 xxxxxxxxxxx   xxxxxxxxxx   |   <img src="${pageContext.request.contextPath}/images/jinghui.png" alt="京公网安备" />京公网安备xxxxxxxxxxx</div>
