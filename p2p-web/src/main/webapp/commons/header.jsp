...
<div class="headBody" id="headBody">
    ...
    <div class="mainBox clearfix">
        <div class="head_l"><span>客服电话：400-xxxx-xxxx</span><em></em><a href="http://weibo.com/xxxx" target="_blank" class="weibo"></a></div>
...
<div id="ewm" class="ewm_layer" style="display:none;">
    ...
    <div class="ewm_weixin">
        <h3>xx网服务号</h3>
        <h4>更多服务请关注xx网服务号</h4>
        <div class="ewm"><img src="images/" alt="xx网服务号"></div>
    </div>
    <div class="ewm_weixin">
        <h3>xx网订阅号</h3>
        <h4>获取xx网最新资讯</h4>
        <div class="ewm"><img src="images/" alt="xx网订阅号"></div>
    </div>
</div>
<!-- 二维码弹出层end -->