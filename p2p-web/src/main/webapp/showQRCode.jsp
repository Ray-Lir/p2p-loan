...
<head>
    ...
    <meta name="keywords" content="xx金融网，投资理财，P2P理财，互联网金融，投资理财，理财，网络贷款，个人贷款，小额贷款，网络投融资平台, 网络理财, 固定收益, 100%本息保障" />
    <meta name="description" content="xx金融网-专业的互联网金融平台！预期年化收益可高达13%，第三方资金托管，屡获大奖。"/>
    <title>xx金融网-专业的互联网金融公司</title>
        ...
        <div class="fund-guanli clearfix">
            ...
            <div class="right-body">
                ...
                <div class="unrecognized" style = "display:block;" id="unrecognized1">
                    ...
                    <img src="${pageContext.request.contextPath}/loan/generateQRCode?rechargeNo=${rechargeNo}&rechargeMoney=${rechargeMoney}&d=" + new Date().getTime() alt=""/>
