...
<head>
    ...
    <meta name="description" content="xx金融网是xx集团旗下一站式互联网金融平台.接入支付清算协会风险系统，用互联网技术和金融创新使投资与借贷更透明、更高效.优选互联网金融产品随心选。"/>
    <title>xx金融网官网-专业的互联网金融信息服务平台</title>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <div class="register welcome">
                    <div class="welcome-txt">欢迎 <span>“<b>${user.phone}</b>”</span><br/>来xx金融网投资！</div>
        ...
        <div class="partners-img">
            ...
            <div class="pic-cnt" id="ISL_Cont">
                <div class="pic-wap">
                    <div id="List1">
                        <!-- 图片列表 begin -->
                        <div class="pic"><a title="金融安全认证权威机构"  href="http://webverify.cfca.com.cn/WebVerify/webVerifyServlet?domain=www.baidu.com" target="_blank" rel="nofollow"><img alt="" src="images/logo_cooperate_1.jpg"/></a></div>
